            ...
            .add(qx.QHBox().set_spacing(8)
                    ...
                    .add(qx.QVBox()
                            .add(qx.QGrid().set_spacing(1)
                                    ...
                                    .next_row()
                                        .add(qx.QLabel().set_text('Masked training'), align=qx.Align.RightF)
                                        .add(qx.QCheckBoxMxFlag(trainer.mx_masked_training))
                                    .next_row()
                                        .add(qx.QLabel().set_text('Edges priority'), align=qx.Align.RightF)
                                        .add(qx.QCheckBoxMxFlag(trainer.mx_edges_priority))
                                    .grid())
                    ...
                    .add(qx.QVBox()
                            .add(qx.QGrid().set_spacing(1)
                                    .row(0)
                                        .add(qx.QLabel().set_text('Enhancer GAN @(QxModelTrainer.power)'), align=qx.Align.RightF)
                                        .add(qx.QDoubleSpinBoxMxNumber(trainer.mx_enhancer_gan_power))
                                    .grid())
                        ,align=qx.Align.CenterV)
