...
class QxMaskEditorCanvas(qx.QHBox):
    def __init__(self, image : NPImage, mask : NPImage = None):
        ...
        red_overlay_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_F1), self)
        red_overlay_shortcut.mx_press.listen( lambda: self._set_overlay_color(qt.QColor(255,0,0)))
        green_overlay_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_F2), self)
        green_overlay_shortcut.mx_press.listen( lambda: self._set_overlay_color(qt.QColor(0,255,0)))
        blue_overlay_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_F3), self)
        blue_overlay_shortcut.mx_press.listen( lambda: self._set_overlay_color(qt.QColor(0,0,255)))
        bw_mode_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_F4), self)
        bw_mode_shortcut.mx_press.listen( lambda: self._set_bw_mode(not self._bw_mode))
        opacity_0_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_Agrave), self)
        opacity_0_shortcut.mx_press.listen( lambda: self._set_overlay_opacity(0.0))
        opacity_25_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_1), self)
        opacity_25_shortcut.mx_press.listen( lambda: self._set_overlay_opacity(0.25))
        opacity_50_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_2), self)
        opacity_50_shortcut.mx_press.listen( lambda: self._set_overlay_opacity(0.50))
        opacity_75_shortcut = qx.QShortcut( qt.QKeyCombination(qt.Qt.Key.Key_3), self)
        ...
        red_overlay_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(255,0,0)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Red_overlay) (F1)')
        ...
        green_overlay_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(0,255,0)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Green_overlay) (F2)')
        ...
        blue_overlay_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(0,0,255)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Blue_overlay) (F3)')
        ...
        bw_mode_btn = qx.QPushButton().set_icon(qt.QIcon(overlay_bw_mode_pixmap)).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.BW_mode) (F4)')
        ...
        opacity_0_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(255,255,255,0)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Opacity) 0% (`)')
        ...
        opacity_25_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(255,255,255,64)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Opacity) 25% (1)')
        ...
        opacity_50_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(255,255,255,128)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Opacity) 50% (2)')
        ...
        opacity_75_btn = qx.QPushButton().set_icon(qt.QIcon(qt.QPixmap_colorized(overlay_pixmap, qt.QColor(255,255,255,196)))).set_icon_size(icon_size).set_tooltip('@(QxMaskEditorCanvas.Opacity) 75% (3)')
